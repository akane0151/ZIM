                    ...
                    <div class="header-button">
                        ...
                        <div class="account-wrap">
                            <div class="account-item clearfix js-item-menu">
                                <div class="image">
                                    <img src="<?php echo base_url(); ?>assets/images/icon/user-profile.jpg" alt="" />
                                </div>
                                <div class="content">
                                    <a id="username" class="js-acc-btn" href="#">...</a>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            function fill(){
                $.ajax({
                    type: "GET",
                    url: "<?php echo site_url('user/getinfo')?>",
                    dataType: "JSON",
                    success: function (data) {
                        if (data != "false") {
                            $("header .account-wrap #username").html(data.username);
            ...
            fill();
            $("header .account-wrap .account-dropdown").on("click", '#logout-btn', function () {
                $.ajax({
                    type: "GET",
